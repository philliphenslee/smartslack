...
module.exports = {
    ...
    * @param {function} callback(err,result)
    */
    getReactions: function (channel, callback) {
        ...
        api.post('reactions.getReactions', function (err, result) {
            if (err) {
                return callback(err);
            }
            callback(null, result);
    ...
    * @param {function} callback(err,result)
    */
    getList: function (channel, callback) {
        if (!_.isFunction(callback)) {
            throw new Error(errors.callback_type);
        }
        ...
        api.post('reactions.getList', function (err, result) {
            if (err) {
                return callback(err);
            }
            callback(null, result);
    ...
    * @param {function} callback(err,result)
    */
    remove: function (emojiName, channel, timestamp, callback) {
